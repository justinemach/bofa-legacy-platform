/*
 * cards-api — mock edge service for the card-services application.
 *
 ...
 * production these routes are served by the CARDS service mesh.
 */
'use strict';
...
const server = http.createServer((req, res) => {
  ...
  if (path === '/health') {
    res.end(JSON.stringify({ status: 'UP', service: 'cards-api', lob: LOB }));
    return;
  }
